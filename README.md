...
[Executables that Implement Portions of SP 800-90B Testing](./docs/SP800-90B_TESTING.md)
...
[Interpretation and Processing Utilities](./docs/INTERPRETATION&PROCESSING_UTILITIES.md)
...
|[translate-data](./docs/INTERPRETATION&PROCESSING_UTILITIES.md##translate-data) | Perform an order-preserving map to arrange the input symbols to (0, ..., k-1).|
|[u32-translate-data](./docs/INTERPRETATION&PROCESSING_UTILITIES.md##u32-translate-data) | Perform an order-preserving map to arrange the input symbols to (0, ..., k-1).|

[H_submitter Production Utilities](./docs/HSUBMITTER_PRODUCTION_UTILITIES.md)
...
[Test Data Production Utilities](./docs/TEST_DATA_PRODUCTION_UTILITIES.md)
...
[Result Interpretation Utilities](./docs/RESULT_INTERPRETATION_UTILITIES.md)
...
[Data Conversion Utilities](./docs/DATA_CONVERSION_UTILITIES.md)
...
[Other Data Utilities](./docs/OTHER_DATA_UTILITIES.md)
